import { Reveal } from '#/pages/site/landing/ui/landing-page'
import { SiteCta } from '#/pages/site/landing/ui/landing-page'
import { Icons } from '#/pages/site/landing/ui/icons'

const STORY_POINTS: [string, string][] = [
  ['Real-time, everywhere', 'Every order, every update — the guest, floor and kitchen all see the same live state.'],
  ['No app to download', 'Guests scan a QR code from their own phone. Nothing to install, nothing to learn.'],
  ['Multi-business ready', 'Built from day one to run multiple venues under one roof without extra setup.'],
]
        ...
        <div className='wrap'>
          <Reveal>
            ...
            <h1 className='about-h1'>
              From a table in Vietnam<br className='about-br' />
            ...
            <p className='about-lead'>
              ...
              whole flow just worked: smooth, fast, invisible. I left thinking hospitality everywhere
        ...
        <div className='wrap about-two-col'>
          ...
          <Reveal className='about-content-col'>
            <div className='founder-card'>
              ...
              <div>
                <h2 className='about-h2' style={{ marginBottom: '4px' }}>Albert Barsegyan</h2>
            ...
            <p className='about-body' style={{ marginTop: '28px' }}>
              ...
              restaurants everywhere — built to be real-time for the kitchen and multi-business ready
              from day one.
            </p>
            <p className='about-body' style={{ marginTop: '20px' }}>
