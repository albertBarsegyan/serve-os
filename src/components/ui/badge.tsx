  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-md font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        secondary: 'border-transparent bg-primary text-secondary-foreground hover:bg-primary/80',
        destructive:
          'border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline: 'text-foreground',
        success: 'border-transparent bg-emerald-500 text-white dark:text-white',
        warning: 'border-transparent bg-amber-500 text-white dark:text-white',
        info: 'border-transparent bg-sky-500 text-white dark:text-white',
      },
    },
    defaultVariants: {
      variant: 'default',
